...
{
  -- Adds better navigation for tmux
...
-- Scroll Offset.
-- This wil set the "padding" in lines, at the beginning and end of a file
vim.opt.scrolloff = 20

-- Set the number of lines to show relative to the current line
vim.wo.relativenumber = true
...
vim.defer_fn(function()
  require('nvim-treesitter.configs').setup {
    ...
    ensure_installed = { 'lua', 'python', 'javascript', 'vimdoc', 'vim', 'bash', 'php', 'html', 'markdown', 'css' },
